...
import logo from './assets/Frame 919.svg';
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center">
            <div className="text-[48px] font-bold text-gray-800">
            <a href="/" className="font-permanent-marker flex">
                <span className="text-[rgb(78,37,37)]">Urban</span> {/* Brown color */}
          ...
          <div className="hidden md:flex space-x-8">
            <a href="/" className="text-gray-700 hover:text-gray-900 text-lg">Home</a>
            <a href="/products" className="text-gray-700 hover:text-gray-900 text-lg">Products</a>
            <a href="/contact" className="text-gray-700 hover:text-gray-900 text-lg">Contact Us</a>
          </div>
